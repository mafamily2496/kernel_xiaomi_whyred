...
/*Speaker control */
 ...
 #define TO_FIXED(e) e
  		...
  		struct kobj_attribute *attr, char *buf)
  {
  	...
  	value = tas2557_get_DAC_gain( sound_control_codec_ptr , TAS2557_SPK_CTRL_REG);
  	value >>= 8;
...
/*	pTAS2557->update_bits( sound_control_codec_ptr ,TAS2557_SPK_CTRL_REG,  value);*/
	tas2557_set_DAC_gain (sound_control_codec_ptr ,  value);
